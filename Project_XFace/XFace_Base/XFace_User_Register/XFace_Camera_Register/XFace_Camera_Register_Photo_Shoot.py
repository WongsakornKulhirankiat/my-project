...
class Screen10(tk.Frame):
    ...
    def camera_shoot_click(self):
        ...
        self.retake_button = customtkinter.CTkButton(master=self.step_frame, text="Retake", command=lambda: self.next_screen(1), font=customtkinter.CTkFont(size=20), text_color="black", width=120, height=60, fg_color="#D9D9D9", bg_color="#ffffff", corner_radius=10)
