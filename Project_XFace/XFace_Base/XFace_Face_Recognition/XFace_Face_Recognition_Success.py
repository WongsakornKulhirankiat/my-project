...
class Screen2(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        btn_attendance = customtkinter.CTkButton(master=self.step_frame, width=60, command= lambda: self.next_screen(), text="Attendance", font=customtkinter.CTkFont(size=20), text_color="black", corner_radius=20, fg_color="#d9d9d9", border_color="#d9d9d9", border_width=1, bg_color="white")
        btn_attendance.place(x=80,y=320)

        # Add Button "Clocking out"
        btn_clocking_out = customtkinter.CTkButton(master=self.step_frame, width=60, command= lambda: self.next_screen(), text="Clocking out", font=customtkinter.CTkFont(size=20), text_color="black", corner_radius=20, fg_color="#d9d9d9", border_color="#d9d9d9", border_width=1, bg_color="white")
        btn_clocking_out.place(x=240,y=320)

        # Add Button "Menu"
        btn_menu = customtkinter.CTkButton(master=self.step_frame, width=60, command= lambda: self.next_screen(4), text="Menu", font=customtkinter.CTkFont(size=20), text_color="black", corner_radius=20, fg_color="#d9d9d9", border_color="#d9d9d9", border_width=1, bg_color="white")
