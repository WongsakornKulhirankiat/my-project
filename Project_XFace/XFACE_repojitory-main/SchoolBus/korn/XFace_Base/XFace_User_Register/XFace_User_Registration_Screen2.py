...
class Screen7(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Camera Button
        cam_btn = customtkinter.CTkButton(master=self.image_frame, text="", command= lambda: self.next_screen(10), image=cam_image, hover=False, border_width=0, width=150, height=140, fg_color="white")
        ...
        # Image Button
        img_btn = customtkinter.CTkButton(master=self.image_frame, text="", command= lambda: self.next_screen(8), image=img_image, hover=False, border_width=0, width=150, height=140, fg_color="white")
