...
class Screen13(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Add Name Label
        name_label = customtkinter.CTkLabel(master=name_frame, text="User Name", text_color="black", font=("Arial", 20), fg_color="transparent")
        name_label.place(relx=0.2, rely=0.01)

        # Add Text Entry for Username
        self.username_entrybox = customtkinter.CTkEntry(master=name_frame, width=200 , height=30, fg_color="white", border_color="white", text_color="black", font=customtkinter.CTkFont(size=15), corner_radius=10)
        self.username_entrybox.place(relx=0.2, rely=0.06)
        self.username_entrybox.bind("<Button-1>", lambda event: self.show_keyboard(self.name_entrybox))
        ...
        department_entrybox = customtkinter.CTkComboBox(name_frame, text_color="black", state="readonly", values=["School1", "School2","School3"], font=("Arial", 15), width=200, height=30, justify="left", fg_color="white", dropdown_text_color="black", dropdown_font=("Arial", 15), dropdown_fg_color="white", dropdown_hover_color="white", button_color="white", border_color="white", button_hover_color="white")
        department_entrybox.place(relx=0.2, rely=0.17)
        ...
        def toggle_detail_frame(toggle, *args, **kwargs):
            ...
            if toggle == 1:
                ...
                # Add Edit Button
                edit_btn = customtkinter.CTkButton(master=detail_frame, command= lambda: self.next_screen(14), text="Edit", text_color="black", hover_color="lightgray", font=("Arial", 20), border_width=0, width=90, height=30, fg_color="#d9d9d9")
