...
class Screen1(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Add Button "pass"
        btn_pass = customtkinter.CTkButton(master=self.step_frame, width=80, command= lambda: self.next_screen(3), text="Pass", font=customtkinter.CTkFont(size=20), text_color="black", corner_radius=10, fg_color="white", border_color="white", border_width=1)
