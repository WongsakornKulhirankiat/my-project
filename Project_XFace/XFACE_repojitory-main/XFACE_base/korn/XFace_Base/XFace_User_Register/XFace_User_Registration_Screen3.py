...
class Screen9(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Add Userid Label
        self.userid_txt_label = customtkinter.CTkLabel(master=self.step_frame2, text="123456", width=240, height=15, font=customtkinter.CTkFont(size=15), text_color="black", justify="center")
        ...
        # Add Button "Save"
        btn_save = customtkinter.CTkButton(master=self.step_frame2, command=lambda: self.next_screen(4), width=80, text="Save", font=customtkinter.CTkFont(size=20), text_color="black", corner_radius=15, fg_color="white", border_color="white", border_width=1)
