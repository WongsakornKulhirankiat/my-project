...
class Screen4(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        edit_wifi_setting_btn = customtkinter.CTkButton(master=self.menu_frame, command= lambda: self.open_wifi_settings(), text="Wifi Setting", text_color="black", font=("Arial Bold", 20), fg_color="white", width=250, height=50, corner_radius=10, border_width=0, hover_color="gray", cursor="hand2")
