...
class Screen5(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        edit_excel_output_btn = customtkinter.CTkButton(master=self.menu_frame, command= lambda: self.next_screen(20), text="Excel Output", text_color="black", font=("Arial Bold", 20), fg_color="white", width=250, height=50, corner_radius=10, border_width=0, hover_color="gray", cursor="hand2")
        edit_excel_output_btn.place(relx=0.52, rely=0.45)
