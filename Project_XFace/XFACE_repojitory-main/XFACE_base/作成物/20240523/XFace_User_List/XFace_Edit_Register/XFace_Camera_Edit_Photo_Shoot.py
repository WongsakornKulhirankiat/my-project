...
class Screen21(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Add "<" Button
        back_btn = customtkinter.CTkButton(master=self.step_frame, command=lambda: self.next_screen(14), width=30, height=30, text="<", text_color="black", font=("Arial", 30), fg_color="transparent", hover=False)
    ...
    def camera_shoot_click(self):
        if self.photogetableflag:
            ...
            self.accept_button = customtkinter.CTkButton(master=self.step_frame, command=lambda: self.next_screen(14), text="OK", font=customtkinter.CTkFont(size=20), text_color="black", width=120, height=60, fg_color="#D9D9D9", bg_color="#ffffff", corner_radius=10)
