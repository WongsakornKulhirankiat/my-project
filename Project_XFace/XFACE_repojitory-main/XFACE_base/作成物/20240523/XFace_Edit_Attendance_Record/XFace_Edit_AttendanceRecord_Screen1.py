...
class Screen18(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Back Button
        back_btn = customtkinter.CTkButton(self.menu_frame, text="<", command=lambda: self.back_screen(), width=30, height=30, text_color="white", font=("Arial", 30), fg_color="transparent")
        ...
        self.init_headers()
        #self.user_id = self.main_app.get_loginuserid()   ###fujiwara syuusei
