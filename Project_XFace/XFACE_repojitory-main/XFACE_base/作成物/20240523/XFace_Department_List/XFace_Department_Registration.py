...
class Screen16(tk.Frame):
    def __init__(self, parent, main_app):
       ...
       #----------------------------------------------------------------------------
        ...
        # Back Button
        back_btn = customtkinter.CTkButton(self.menu_frame, text="<", command=lambda: self.back_screen(15), width=30, height=30, text_color="white", font=("Arial", 30), fg_color="transparent")
        ...
        self.department_name_entry = customtkinter.CTkEntry(self.menu_frame, placeholder_text="IT", font=("Arial", 20),  width=400, height=35)
        ...
        # Next Button
        save_btn = customtkinter.CTkButton(self.menu_frame, text=Department_Registration_textdir[10], command=lambda: self.next_screen(), text_color="black", font=("Arial", 20, "bold"), fg_color="white", width=90, height=50, corner_radius=10, border_width=0, hover_color="gray", cursor="hand2")
    ...
    def next_screen(self):
        ...
        if not department_name.strip():
            messagebox.showerror(Department_Registration_textdir[8], Department_Registration_textdir[9])
            return
        
        XFace_Database_Function.insert_department(department_name, start_time, end_time, rest_time, over_time)
        messagebox.showinfo(Department_Registration_textdir[11],Department_Registration_textdir[12])
