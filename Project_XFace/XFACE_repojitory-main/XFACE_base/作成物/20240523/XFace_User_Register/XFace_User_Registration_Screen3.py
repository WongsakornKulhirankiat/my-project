...
class Screen9(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Add "<" Button
        back_btn = customtkinter.CTkButton(master=self.step_frame, width=30, height=30, command= lambda: self.next_screen(15), text="<", text_color="black", font=("Arial", 30), fg_color="transparent", hover=False)
    ...
    #def get_registerphoto(self):
    #   self.registerphotopath = self.main_app.get_administrator()
    #   self.profile_label.configure(image=self.profile_label)
