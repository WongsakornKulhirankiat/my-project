...
class User_Registration_Screen2_error(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        self.error_frame = customtkinter.CTkFrame(self, width=600, height=350, fg_color="#e6e6e6", corner_radius=0)
        self.error_frame.pack()

        # Add Square
        self.error_square = customtkinter.CTkFrame(master=self.error_frame,width=500, height=250, fg_color="#e6e6e6", corner_radius=20, border_color="black", border_width=2)
        ...
        # Add Button "OK"
        btn_ok = customtkinter.CTkButton(master=self.error_frame, width=80, command= lambda: self.next_screen(14), text="OK", font=customtkinter.CTkFont(size=20), text_color="black", corner_radius=20, fg_color="white", border_color="white", border_width=1)
