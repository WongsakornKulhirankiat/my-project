...
from XFace_ExcelOutput_Function import AttendanceRecord
from XFace_ExcelOutput_Function import EmployeeInfo
import XFace_Database_Function
employeeinfo = EmployeeInfo()
attendancerecord = AttendanceRecord()

class Exceloutput2(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Back Button
        back_btn = customtkinter.CTkButton(self.menu_frame, text="<", command=lambda: self.back_screen(3), width=30, height=30, text_color="white", font=("Arial", 30), fg_color="transparent")
    ...
    def get_user_id(self):
        ...
        self.user_name = XFace_Database_Function.fetch_username(self.user_id)       
        # AttendanceRecord User Button
        AttendanceRecord_user_btn = customtkinter.CTkButton(self.menu_frame, text="AttendanceRecord User", command=lambda:self.ExcelOutput_user(self.user_id, self.user_name[0], self.yearmonth_entry.get()), text_color="black", font=("Arial", 15, "bold"), fg_color="white", width=50, height=25, corner_radius=10, border_width=0, hover_color="gray", cursor="hand2")
