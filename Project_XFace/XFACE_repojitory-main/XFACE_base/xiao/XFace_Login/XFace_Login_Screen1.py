...
class Login1(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        del_btn = customtkinter.CTkButton(master=self.numpad_frame, text="⌫", text_color="black", font=("Tahoma", 30), width=75, height=75, fg_color="#d6d6d6", corner_radius=10, hover_color="gray", cursor="hand2")
    ...
    def check_password(self):
        ...
        user = XFace_Database_Function.chack_user(userid, password)
        ...
        if user:
            ...
            #self.main_app.set_current_password(self.password)
