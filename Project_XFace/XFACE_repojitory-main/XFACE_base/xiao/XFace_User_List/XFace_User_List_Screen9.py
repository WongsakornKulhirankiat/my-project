...
class Userinfo1(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        for filename in os.listdir(images_folder):
            if "portrait" in filename:
                ...
                portrait_image = ImageTk.PhotoImage(pil_image)  
                ctk_image = CTkImage(pil_image)  
                self.portraits_list.append((portrait_image, ctk_image))
        ...
        # Add "<" Button
        back_btn = customtkinter.CTkButton(master=self.name_frame, command= lambda: self.back_screen(5), width=30, height=30, text="<", text_color="black", font=("Arial", 30), fg_color="transparent", hover=False)
    ...
    def toggle_detail_frame(self, toggle, *args, **kwargs):
        if toggle == 1:
            ...
            name = kwargs.get('b', "")
            portrait_image = self.portraits_list[index][0]
            ...
            canvas_detail.create_image(87, 87, image=portrait_image, anchor=tk.CENTER)
            ...
            edit_btn = customtkinter.CTkButton(master=detail_frame, command=lambda: self.next_screen(name, 10), text="Edit", text_color="black", hover_color="lightgray", font=("Arial", 20), border_width=0, width=90, height=30, fg_color="#d9d9d9")
    ...
    def next_screen(self, name, index):
        ...
        self.main_app.set_user_name(user_name)
        self.main_app.set_current_password(password)
        self.main_app.set_department_name(department_name)
