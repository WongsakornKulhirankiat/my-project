...
class Edituserinfo1(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Add Button "Save"
        btn_save = customtkinter.CTkButton(master=step_frame3, command= lambda:self.next_screen(5), width=80, text="Save", font=customtkinter.CTkFont(size=20), text_color="black", corner_radius=15, fg_color="white", border_color="white", border_width=1)
    ...
    def get_department_name(self):
        self.department_entrybox_txt = self.main_app.get_department_name()
        self.department_entrybox.delete(0, tk.END) 
        self.department_entrybox.insert(0, self.department_entrybox_txt)

    def get_user_name(self):
        self.username_entrybox_txt = self.main_app.get_user_name()
        self.username_entrybox.delete(0, tk.END)
        self.username_entrybox.insert(0, self.username_entrybox_txt)

    def get_current_password(self):
        self.password_entrybox_txt = self.main_app.get_current_password()
        self.password_entrybox.delete(0, tk.END)
