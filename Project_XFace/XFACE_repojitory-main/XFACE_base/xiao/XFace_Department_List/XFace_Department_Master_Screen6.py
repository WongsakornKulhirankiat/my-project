...
class Department_Registration_Screen1(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # create Button
        create_btn = customtkinter.CTkButton(master=self.name_frame,  command= lambda: self.back_screen(7), text="Create", text_color="black", hover_color="lightgray", font=("Arial", 20), border_width=0, width=200, height=30, fg_color="white", corner_radius=15)
    ...
    def toggle_detail_frame(self, toggle, *args, **kwargs):
        if toggle == 1:
            ...
            edit_btn = customtkinter.CTkButton(master=detail_frame, command=lambda: self.next_screen(name, 8), text="Edit", text_color="black", hover_color="lightgray", font=("Arial", 20), border_width=0, width=90, height=30, fg_color="#d9d9d9")
