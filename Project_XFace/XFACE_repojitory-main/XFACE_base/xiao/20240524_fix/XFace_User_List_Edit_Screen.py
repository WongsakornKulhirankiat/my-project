...
class Screen14(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        for department in department_names:
            self.department_listbox.insert("end", department) ###xiao_fix 20240523  [0] -> delete
    ...
    def save(self, index):
        ...
        userid, username, _, _, adminflag, face_photo = userinfo[0] ###xiao_fix 20240523 
        #face_photo = self.main_app.get_registerfacephoto() ###xiao_fix 20240523 顔写真の更新があるかどうかはどのように判定？
        XFace_Database_Function.update_userinfo(userid, self.username_entrybox.get(), self.password_entrybox.get(), self.department_entrybox.get(), adminflag, face_photo)
