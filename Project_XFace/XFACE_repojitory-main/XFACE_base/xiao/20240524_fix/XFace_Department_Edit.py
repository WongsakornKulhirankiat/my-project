...
class Screen17(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Save Button
        save_btn = customtkinter.CTkButton(self.menu_frame, text=Department_Registration_textdir[10], command=lambda: self.save_data(), text_color="black", font=("Arial", 20, "bold"), fg_color="white", width=90, height=50, corner_radius=10, border_width=0, hover_color="gray", cursor="hand2")
    ...
    def save_data(self):  ###xiao_fix 20240523 index delete
